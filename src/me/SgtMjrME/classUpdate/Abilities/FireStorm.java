...
public class FireStorm extends BaseAbility {
	...
	public boolean onInteract(Player p, PlayerInteractEvent e) { // TODO: Mount Fireballs on ArmorStand to slow them down to sane speed, because Mojang always breaks things
