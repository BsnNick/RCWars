			...
			if (split.length != 5) {
				...
				if (t == null)
				{
				    try
				    {
				        ...
				        {
				            case 101:
				                t = Material.IRON_BARS;
				                break;
				            default:
				                    t = Material.PINK_GLAZED_TERRACOTTA; // Debug
				                    
				        }
				    } catch (Exception e) {}
				}
				
				//org.bukkit.block.data.BlockData d = Bukkit.createBlockData(split[4]); // byte data -> BlockData //TODO: DEBUG
				org.bukkit.block.data.BlockData d = t.createBlockData();
