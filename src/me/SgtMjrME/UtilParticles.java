...
import me.SgtMjrME.ReflectionUtils.PackageType;
...
public enum UtilParticles {
	...
	private static final Map<String, UtilParticles> NAME_MAP = new HashMap<String, UtilParticles>();
	private static final Map<Integer, UtilParticles> ID_MAP = new HashMap<Integer, UtilParticles>();
	...
	static {
		for (UtilParticles effect : values()) {
	 ...
	 */
	private UtilParticles(String name, int id, int requiredVersion, ParticleProperty... properties) {
		this.name = name;
		this.id = id;
	 ...
	 */
	public static UtilParticles fromName(String name) {
		for (Entry<String, UtilParticles> entry : NAME_MAP.entrySet()) {
	 ...
	 * @return The particle effect
	 */
	public static UtilParticles fromId(int id) {
		for (Entry<Integer, UtilParticles> entry : ID_MAP.entrySet()) {
			if (entry.getKey() != id) {
				continue;
			}
			return entry.getValue();
	...
	private static boolean isWater(Location location) {
		...
		return material == Material.WATER; // No more stationary water?
	}
	 ...
	 */
	private static boolean isDataCorrect(UtilParticles effect, ParticleData data) {
	 ...
	 */
	private static boolean isColorCorrect(UtilParticles effect, ParticleColor color) {
	 ...
	 * @see ParticlePacket#ParticlePacket(UtilParticles, Vector, float, boolean, ParticleData)
	 * @see ParticlePacket#sendTo(Location, double)
	 */
	 ...
	 * @see ParticlePacket#ParticlePacket(UtilParticles, ParticleColor, boolean)
	 * @see ParticlePacket#sendTo(Location, double)
	 */
	...
	/**
	 * Represents the particle data for effects like {@link UtilParticles#ITEM_CRACK}, {@link UtilParticles#BLOCK_CRACK} and {@link UtilParticles#BLOCK_DUST}
	 * <p>
	 * This class is part of the <b>ParticleEffect Library</b> and follows the same usage conditions
	 * 
	 * @author DarkBlade12
	...
	/**
	 * Represents the item data for the {@link UtilParticles#ITEM_CRACK} effect
	 * <p>
	 * This class is part of the <b>ParticleEffect Library</b> and follows the same usage conditions
	 * 
	 * @author DarkBlade12
	...
	/**
	 * Represents the block data for the {@link UtilParticles#BLOCK_CRACK} and {@link UtilParticles#BLOCK_DUST} effects
	 * <p>
	 * This class is part of the <b>ParticleEffect Library</b> and follows the same usage conditions
	 * 
	 * @author DarkBlade12
	...
	/**
	 * Represents the color for effects like {@link UtilParticles#SPELL_MOB}, {@link UtilParticles#SPELL_MOB_AMBIENT}, {@link UtilParticles#REDSTONE} and {@link UtilParticles#NOTE}
	 * <p>
	 * This class is part of the <b>ParticleEffect Library</b> and follows the same usage conditions
	 * 
	 * @author DarkBlade12
	...
	/**
	 * Represents the color for effects like {@link UtilParticles#SPELL_MOB}, {@link UtilParticles#SPELL_MOB_AMBIENT} and {@link UtilParticles#NOTE}
	 * <p>
	 * This class is part of the <b>ParticleEffect Library</b> and follows the same usage conditions
	 * 
	 * @author DarkBlade12
	...
	/**
	 * Represents the color for the {@link UtilParticles#NOTE} effect
	 * <p>
	 * This class is part of the <b>ParticleEffect Library</b> and follows the same usage conditions
	 * 
	 * @author DarkBlade12
	...
	public static final class ParticlePacket {
		...
		private final UtilParticles effect;
		 ...
		 * @see #initialize()
		 */
		public ParticlePacket(UtilParticles effect, float offsetX, float offsetY, float offsetZ, float speed, int amount, boolean longDistance, ParticleData data) throws IllegalArgumentException {
			initialize();
			if (speed < 0) {
		 ...
		 */
		public ParticlePacket(UtilParticles effect, Vector direction, float speed, boolean longDistance, ParticleData data) throws IllegalArgumentException {
		 ...
		 * @see #ParticleEffect(ParticleEffect, float, float, float, float, int, boolean, ParticleData)
		 */
		public ParticlePacket(UtilParticles effect, ParticleColor color, boolean longDistance) {
